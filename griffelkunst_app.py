...
_page_icon = "https://www.griffelkunst.de/galleryimages/_xlarge/E627.jpg"
st.set_page_config(
...
# ─── Favicon (Ceal Floyer „First Edition") robust per Browser-Skript setzen ───
components.html("""
<script>
(function(){
  try{
    var d = window.parent.document;
    var url = 'https://www.griffelkunst.de/galleryimages/_xlarge/E627.jpg';
    d.querySelectorAll("link[rel~='icon']").forEach(function(l){ l.parentNode.removeChild(l); });
    var link = d.createElement('link'); link.rel = 'icon'; link.type = 'image/jpeg'; link.href = url;
